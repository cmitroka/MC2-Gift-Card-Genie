    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "giftcard_cvs", txtCardNumber.Text);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "accesscode_cvs", txtCardPIN.Text);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.OuterHtml, "Get Card History", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("gift card balance is:", "<!--", test);
                if (balanceResult == "")
                {
                    //Instruction--;
                    //SpecificRetryCnt++;
