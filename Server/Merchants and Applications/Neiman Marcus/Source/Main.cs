...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "billingGiftCardNumber0", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "billingGiftCardCinNumber0", txtCardPIN.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.a, HTMLEnumAttributes.id, "billingGiftCardCheckValue", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("CIN NUMBER VALUE", "$0.00", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
