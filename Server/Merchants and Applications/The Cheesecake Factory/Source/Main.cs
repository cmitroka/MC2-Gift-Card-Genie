...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.ElementExists(FrameDoc, HTMLEnumTagNames.div, HTMLEnumAttributes.id, "giftCardCheck");
            ...
            else if (Instruction == 3)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.src, "*%checkBalance", "");
                HandleInstruction(OK);
            }
            else
            {
                ...
                if (balanceResult == "") balanceResult = GetBalance("Remaining Balance", "Need", test);
                if (balanceResult == "")
                {
                    OK = "-1";
                    string VendErr1 = "You have entered invalid gift card or pin or a system error has occurred.";
