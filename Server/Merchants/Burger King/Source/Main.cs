    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else
            {
                ...
                string testcp = UIFunc_DoManualCopyAndPaste.DoManualCopyAndPaste(this, IE);
                //GCGMethods.WriteFile("C:\\testi.txt", testi, true);
                //GCGMethods.WriteFile("C:\\testo.txt", testo, true);
                //GCGMethods.WriteFile("C:\\testcp.txt", testcp, true);
                //InspectIt(test, "has a balance ");
                balanceResult = GetBalance("Your current balance is ", "MANAGE", testcp);
                if (balanceResult == "")
                {
                    SpecificRetryCnt++;
