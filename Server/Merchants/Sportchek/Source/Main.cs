...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = DoHandleCAPTCHARqRs(61, 235, 150, 50);
            ...
            else if (Instruction == 3)
            {
                ...
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.src, "*%submit.gif", "");
                HandleInstruction(OK);
            }
            else
            {
                ...
                balanceResult = GetBalance("* is", "view", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
