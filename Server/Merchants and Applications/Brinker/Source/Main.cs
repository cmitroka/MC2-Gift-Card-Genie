...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = WebpageLib00.ElemInputEnvoke(IE, "card_number", txtCardNumber.Text);
                if (OK != "-1") OK = WebpageLib00.ElemInputEnvoke(IE, "recaptcha_response_field", txtCAPTCHAAnswer.Text);
                if (OK != "-1") OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zdiv, "tw_bc_cont", "",1);
                HandleInstruction(OK);
            }
