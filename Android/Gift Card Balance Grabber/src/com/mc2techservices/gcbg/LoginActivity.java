...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String pUsername = AppSpecificFunctions.ReadSharedPreference(context,
				"Username");
		String pPassword = AppSpecificFunctions.ReadSharedPreference(context,
				"Password");
		...
		if (AppSpecificFunctions.ReadSharedPreference(context, "AutoStart")
				.equals("1")) {
			chkAutoLogin.setChecked(true);
			String pDoAutoStart=AppSpecificFunctions.ReadSharedPreference(context,"DoAutoStart");
			if (pDoAutoStart.equals("1")) {
				AppSpecificFunctions.WriteSharedPreference(context,
						"DoAutoStart", "0");
				DoLogin();
			}
		}
	...
	private String validateInfo() {
		...
		retVal = AppSpecificFunctions.PMValidateInfo(pTempPassword,
				pTempPasswordVer, pTempLogin);
		return retVal;
	}
	...
	public void onAutoLoginClick(View arg0) {
		...
		if (chkAutoLogin.isChecked()) {
			AppSpecificFunctions.WriteSharedPreference(context, "AutoStart",
					"1");
	...
	private String BuildParamString() {
		String retVal = "";
		String zUsername = ((EditText) findViewById(R.id.etUsername)).getText()
				.toString();
		String zPassword = ((EditText) findViewById(R.id.etPassword)).getText()
				.toString();
		...
		protected String doInBackground(String... params) {
			...
			try {
				try {
					...
					Log.d("WS Call Detail", "Post parameters : "
							+ urlParameters);
