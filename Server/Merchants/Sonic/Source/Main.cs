    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "PinNumber", txtCardPIN.Text);
            ...
            else
            {
                ...
                if (balanceResult == "") balanceResult = GetBalance("Balance Check", "Balance", test);
                if (balanceResult == "")
                {
                    OK = "-1";
                    string VendErr1 = "Invalid card number or pin.";
