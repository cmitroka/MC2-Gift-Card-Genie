...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zinput, WebpageLib00.UsingIdentifier.Zid, WebpageLib00.ComparisonType.Zexact, "giftcardnumber", txtCardNumber.Text, 1);
                if (OK != "-1")
                {
                    DoGCGDelay(10, true);
                    OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zinput, WebpageLib00.UsingIdentifier.Zvalue, WebpageLib00.ComparisonType.Zexact, "Check Balance", "", 1);
                }
            ...
            else
            {
                ...
                balanceResult = GetBalance("has a balance of: $", "</span>", testi);
                if (balanceResult == "")
                {
                    SpecificRetryCnt++;
                    ...
                    else if (test.Contains("The text did not match the image. Please try again"))
                    {
                    ...
                    else if (test.Contains("t0b1tn4"))
                    {
                        txtCardBalance.Text = "t0b1tn4";
                        SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "Try again, something went wrong last time.", ad.RsPathAndFileToWrite);
                        OK = "1";
                    }
                }
                else
