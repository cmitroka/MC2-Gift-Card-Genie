...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK= GCGMethods.ElementExists(FrameDoc,HTMLEnumTagNames.img, HTMLEnumAttributes.src, "*%secure");
                HandleInstruction(OK);
            }
            else if (Instruction == 3)
            {
                OK = CAPTCHALib.DoHandleCAPTCHARqRs(this, 270, 440);
                HandleInstruction(OK);
            }
            ...
            else
            {
                ...
                balanceResult = GetBalance("Current Dollar Balance", "CAD", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
        ...
        private void DoMacro0()
        {
            ...
            string FileToUse = GCGCommon.PMC.WriteMacro(txtRqRsPath.Text, "" +
                "Pause,1000~!~" +
                "WinMove,0,0,800,700,Balance Extractor - Lowes~!~" +
                "Pause,1000~!~" +
                "Move,479,429~!~" +
                "RightClick~!~" +
                "Pause,1000~!~" +
