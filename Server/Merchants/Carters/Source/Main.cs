    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK == "1") PMCMacros.DoMacro0(this);
                HandleInstruction(OK);
            }
            else if (Instruction == 3)
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "dwfrm_billinggiftcert_giftCertPin", txtCardPIN.Text);
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.button, HTMLEnumAttributes.id, "gc-checkbalance", "");
                HandleInstruction(OK);
            }
            ...
            else
            {
                ...
                balanceResult = GetBalance("Your gift card balance is", "Secondary", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
