    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                try
                {
                    p1 = txtCardNumber.Text.Substring(0, 10);
                    p2 = txtCardNumber.Text.Substring(10, 3);
                    p3 = txtCardNumber.Text.Substring(13, 3);
                    p4 = txtCardNumber.Text.Substring(16, 3);
                    p5 = txtCardNumber.Text.Substring(16, 3);
                }
                catch (Exception ex) { }

                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_PlaceHolderMain_txtCardNumberPrefix", p1);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_PlaceHolderMain_txtCardNumberFirstThree", p2);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_PlaceHolderMain_txtCardNumberMiddleThree", p3);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_PlaceHolderMain_txtCardNumberLastThree", p4);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_PlaceHolderMain_txtPin", txtCardPIN.Text);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.a, HTMLEnumAttributes.id, "ctl00_PlaceHolderMain_btnCheckBalance", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("balance is: $", "Gift", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
