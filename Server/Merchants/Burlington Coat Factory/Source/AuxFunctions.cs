    ...
    public static class AuxFunctions
    {
        ...
        public static void LoadSettings(Main m)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    WDCredCleanName = WDDataArray[5];
                    WDCredSupportCode = WDDataArray[6];
                    WDCredTimeout = WDDataArray[7];
        ...
        public static string LoadCLIrqFile(Main m)
        {
            ...
            if (m.CLIrqFile == "")
            {
                ...
                m.txtCleanName.Text = WDCredCleanName;
                m.txtTimeout.Text = WDCredTimeout;
                m.cmbSupportCode.Text = WDCredSupportCode;
