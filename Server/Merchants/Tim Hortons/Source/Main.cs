...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "accountSvCard$svCardNbr", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "accountSvCard$pin", txtCardPIN.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "btnViewBal", "");
            ...
            else
            {
                ...
                test = UIFunc_DoManualCopyAndPaste.DoManualCopyAndPaste(this);
        ...
        private void DoMacro1()
        {
            ...
            string FileToUse = GCGCommon.PMC.WriteMacro(txtRqRsPath.Text, "" +
                "Pause,100~!~" +
                "WinActivate,Balance Extractor - Panera~!~" +
                "Pause,100~!~" +
                "Move,90,584~!~" +
                "LeftClick~!~" +
                "Pause,100~!~" +
