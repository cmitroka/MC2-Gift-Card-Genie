...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.a, HTMLEnumAttributes.InnerText, "View your Pier 1 Gift Card balance", "");
                HandleInstruction(OK);
            }
            else if (Instruction == 3)
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.a, HTMLEnumAttributes.InnerText, "click here", "");
                HandleInstruction(OK);
            }
            else if (Instruction == 4)
            {
                OK = DoHandleCAPTCHARqRs("WBServlet?jsessionid");
                HandleInstruction(OK);
            }
            else if (Instruction == 5)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.value, "Submit", "");
                HandleInstruction(OK);
            }
        ...
        private void PlayMacro(string Script)
        {
            ...
            tmrRunning.Enabled = false;
            string temp = SupportMethods.CreateAlphaNumericKey(6) + ".txt";
