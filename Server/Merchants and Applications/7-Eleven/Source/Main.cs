    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (SpecificRetryCnt == (SpecificRetryCntMax - 1))
                {
                    SpecificRetryCnt = 0;
                    Instruction--;
                }
                ...
                FrameFixer++;
                GCGMethods.WriteTextBoxLog(txtLog, "FrameFixxer: " + FrameFixer);
                if (FrameFixer == 3)
                {
                ...
                {
                    OK = DoHandleCAPTCHARqRs("type=rca",FrameFixer-1);
                }
                HandleInstruction(OK);
            }
            else if (Instruction == 3)
            {
                PMCMacros.DoMacro7Eleven(this);
            }
            else
            {
                RetryCntMax = 0;
                ...
                string balanceResult = GetBalance("Balance:", "Transaction", test);
                if (balanceResult == "")
                {
                    OK = "-1";
