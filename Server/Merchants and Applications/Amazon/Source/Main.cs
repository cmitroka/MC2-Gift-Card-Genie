...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ap_email", txtLogin.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ap_password", txtPassword.Text);
                if (OK == "1")
                {
                    OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "signInSubmit-input", "");
                }
            ...
            else
            {
                ...
                balanceResult = GetBalance("Available Gift Card Balance", "amznJQ", test);
                if (balanceResult == "")
                {
                    OK = "-1";
