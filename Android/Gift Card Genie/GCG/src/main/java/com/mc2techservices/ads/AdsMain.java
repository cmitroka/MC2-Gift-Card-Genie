...
public class AdsMain {
    private static String pXMLNS;
    private static String pWebServiceURL;
    public String pLD = "XZQX";
    public String pPD = "~_~";
    public String AdsResponse;

    public AdsMain() {
        pXMLNS = "xmlns=\"shared.mc2techservices.com\">";
        pWebServiceURL = "http://www.mc2techservices.com/Shared/AdsWS.asmx";
    }

    public AdsMain(String pXMLNSIn, String pWebServiceURLIn) {
        pXMLNS = pXMLNSIn;
        pWebServiceURL = pWebServiceURLIn;
    }
