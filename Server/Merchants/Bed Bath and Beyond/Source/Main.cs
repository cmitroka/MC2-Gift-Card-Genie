    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "giftCardPin", txtCardPIN.Text);
                HandleInstruction(OK);
            }
            else if (Instruction == 3)
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.classs, "btnSubmit", "");
                HandleInstruction(OK);
            }
            else
            {
                ...
                balanceResult = GetBalance("Card Value:","typeof", test);
                if (balanceResult == "")
                {
                    OK = "-1";
                    string VendErr1 = "An error occurred while processing your gift card. Please verify the numbers and try again.";
