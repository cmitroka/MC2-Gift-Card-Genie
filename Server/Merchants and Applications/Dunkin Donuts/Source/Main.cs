    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "CARD_PIN", txtCardPIN.Text);
                GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.button, HTMLEnumAttributes.id, "checkBalanceSbmtHidden");
                DoDelay(5, true);
            ...
            else
            {
                ...
                string balanceResult = GetBalance("****", "card", test);
                if (balanceResult == "")
                {
                    RetryCnt++;
                    if (RetryCnt < 3)
