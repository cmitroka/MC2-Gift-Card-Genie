    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "submit", "");
            ...
            else
            {
                ...
                try
                {
                    int l4l = txtCardNumber.Text.Length - 8;
                    l4 = txtCardNumber.Text.Substring(l4l, 8);
                }
                catch (Exception ex)
                {
                }
                balanceResult = GetBalance(l4, "Card", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
