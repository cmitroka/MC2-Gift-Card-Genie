    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                {
                    int td = GCGMethods.FindWhatFrameItsIn(IE, "cardnum");
                    IHTMLDocument2 x = GCGMethods.ConvertIEToIHTMLDocument2(IE, td);
                    SetForegroundWindowByHWND(IE.HWND);
                    OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zname, "cardnum", txtCardNumber.Text, 1);
                    if (OK == "1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zname, "cert_pin", txtCardPIN.Text, 1);
                    if (OK == "1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zname, "balance_check", "", 1);
                ...
                else
                {
                    ...
                    balanceResult = GetBalance("Current Balance", "USD", testi);
                    if (balanceResult == "")
                    {
                        SpecificRetryCnt++;
