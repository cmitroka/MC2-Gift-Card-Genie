...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "gift-card-number", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "gift-card-pin", txtCardPIN.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.div, HTMLEnumAttributes.InnerText, "Submit", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("your gift card balance:", "gift", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
