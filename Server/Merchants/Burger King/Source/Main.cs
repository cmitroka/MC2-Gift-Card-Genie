...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "TextBoxCardNumber", txtCardNumber.Text);
                if (OK != "-1") OK = GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ButtonCheckCardBalance");
            ...
            else
            {
                ...
                string balanceResult = GetBalance("Your current balance is", "MANAGE", test);
                if (balanceResult == "")
                {
                    OK = "-1";
                    HandleInstruction(OK);
