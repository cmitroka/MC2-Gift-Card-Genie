...
using System.Text.RegularExpressions;
    ...
    {
        public static string LINEDEL = "^)(";
        public static string POSDEL = "~_~";
        ...
        {
            string retVal = "1";
            SQLHelper sqlh = new SQLHelper(SQLHelper.MDBBaseLoc.CurrentDomainBaseDirectory, "App_Data\\GCGApp.mdb");
