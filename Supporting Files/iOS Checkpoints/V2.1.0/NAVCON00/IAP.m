...
- (void)viewDidLoad
{
    ...
    NSString *temp3=[NSString stringWithFormat:@"As the button tries to indicate, this purchase option will give you %@ successful lookups for .99", sd.pAmntForADollar];
    [lblPurchaseQuantity setText:temp3];
