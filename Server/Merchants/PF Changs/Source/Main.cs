    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                {
                    int td = GCGMethods.FindWhatFrameItsIn(IE, "giftcards-balance-card-number-input");
                    IHTMLDocument2 x = GCGMethods.ConvertIEToIHTMLDocument2(IE, td);
                    //SetForegroundWindowByHWND(IE.HWND);
                    OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Ztestid, "giftcards-balance-card-number-input", txtCardNumber.Text, 1);
                    if (OK != "-1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Ztestid, "giftcards-balance-pin-input", txtCardPIN.Text, 1);
                    if (OK != "-1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zbutton, GCGMethods.HTMLAttributes.Ztestid, "giftcards-balance-check-balance-button", "", 1);
                ...
                else
                {
                    ...
                    balanceResult = GetBalance("You have ", "</strong>", testi);
                    if (balanceResult == "")
                    {
                        SpecificRetryCnt++;
