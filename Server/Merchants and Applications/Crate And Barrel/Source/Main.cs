    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "cardPIN", txtCardPIN.Text);
            ...
            else
            {
                ...
                if (test.Contains("8/14/2012"))
                {
                }
                else
                {
                    balanceResult = GetBalance("Balance:", "As of", test);
                }
