    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "giftCardCheckBalanceButton", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("balance:", "report", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
