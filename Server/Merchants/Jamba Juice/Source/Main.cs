...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "cardBalanceStepOne:newCard:txtCardNumber", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "cardBalanceStepOne:newCard:txtPIN", txtCardPIN.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.a, HTMLEnumAttributes.id, "cardBalanceStepOne_lbtnContinue", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("The balance is", "register", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
