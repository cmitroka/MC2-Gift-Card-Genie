    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                {
                    int td = GCGMethods.FindWhatFrameItsIn(IE, "txtGiftCardNumber");
                    IHTMLDocument2 x = GCGMethods.ConvertIEToIHTMLDocument2(IE, td);
                    SetForegroundWindowByHWND(IE.HWND);
                    OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zid, "txtGiftCardNumber", txtCardNumber.Text, 1);
                    if (OK != "-1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zid, "txtGiftCardPinNumber", txtCardPIN.Text, 1);
                    if (OK != "-1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Za, GCGMethods.HTMLAttributes.Zid, "btnCheckBalance", "", 1);
                ...
                else
                {
                    ...
                    balanceResult = GetBalance("lblGiftCardAvailableBalance\">", "</span>", testi);
                    if (balanceResult == "")
                    {
                        SpecificRetryCnt++;
