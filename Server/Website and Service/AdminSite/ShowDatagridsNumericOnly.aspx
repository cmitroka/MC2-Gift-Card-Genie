<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ShowDatagridsNumericOnly.aspx.cs" Inherits="AppAdminSite.ShowDatagridsNumericOnly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TrueAmnt" DataFormatString="{0:c}" 
                                 HeaderText="True Amount" SortExpression="TrueAmnt"  />
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [qryReportRqRsResultsV01] ORDER BY [TimeLogged] desc" 
