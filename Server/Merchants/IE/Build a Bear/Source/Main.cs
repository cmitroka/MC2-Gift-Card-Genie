    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                {
                    OK = SetFocusOnElement("/atg/userprofiling/ProfileFormHandler.value.giftCardId", GCGMethods.ByNameOrID.Name, -1);
                    //DoGCGDelay(10, true);
                    HandleInstruction(OK);
                ...
                else if (Instruction == 4)
                {
                    ...
                    //OK = DoHandleCAPTCHARqRs("getCaptcha.jsp?"); //image?c= //kaptcha?
                    //HandleInstruction(OK);
                }
                else if (Instruction == 999)
                {
                    ...
                    DoHandleTyper(txtCardNumber.Text + "{TAB}" + txtCardPIN.Text + "{TAB}{TAB}{TAB}{TAB}{TAB}" + txtCAPTCHAAnswer.Text + "{TAB}{ENTER}");
                ...
                else
                {
                    ...
                    try
                    {
                        p1 = txtCardNumber.Text.Substring(12, 4);
                    }
                    catch (Exception ex)
                    {
                    }
                    ...
                    //GCGMethods.WriteFile("C:\\testi.txt", testi, true);
                    balanceResult = GetBalance(p1 + "</td><td>", "</td>", testi);
                    if (balanceResult == "")
                    {
                        OK = "-1";
