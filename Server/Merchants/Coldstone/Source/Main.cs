    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 3)
            {
                ...
                if (OK != "-1") OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zdiv, WebpageLib00.UsingIdentifier.Zid, WebpageLib00.ComparisonType.Zexact, "tw_bc_cont", "", 1);
                HandleInstruction(OK);
            }
            ...
            else
            {
                ...
                balanceResult = GetBalance("span> is $", ".<span", testi);
                if (balanceResult == "")
                {
                    SpecificRetryCnt++;
