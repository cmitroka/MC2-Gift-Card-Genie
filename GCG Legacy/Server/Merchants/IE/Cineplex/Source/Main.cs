        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                else if (Instruction == 2)
                {
                    ...
                    OK = GCGMethods.ElementExists(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zid, "gift-card-number");
                ...
                else if (Instruction == 4)
                {
                    ...
                    IHTMLDocument2 x = GCGMethods.ConvertIEToIHTMLDocument2(IE, -1);
                    OK = SetFocusOnElement("gift-card-number", GCGMethods.ByNameOrID.Id, -1);
                    if (OK == "-1")
                    {
                        HandleInstruction(OK);
                        return;
                ...
                else
                {
                    ...
                    balanceResult = GetBalance("giftCardBalance\">", "span", testi);
                    if (balanceResult == "")
                    {
                        SpecificRetryCnt++;
