        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                else if (Instruction == 2)
                {
                    ...
                    IHTMLDocument2 x = GCGMethods.ConvertIEToIHTMLDocument2(IE, -1);
                    OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zid, "giftNumber",txtCardNumber.Text);
                    if (OK == "1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zid, "giftCardPIN", txtCardPIN.Text);
                    if (OK == "1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zname, "/bn/userprofiling/GiftCardFormHandler.checkBalance", "");
                ...
                else
                {
                    ...
                    balanceResult = GetBalance("Current Balance :", "</div>", testi);
                    if (balanceResult == "")
                    {
                        SpecificRetryCnt++;
