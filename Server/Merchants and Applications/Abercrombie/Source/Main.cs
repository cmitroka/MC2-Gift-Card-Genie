                ...
                else
                {
                    ...
                    if (balanceResult == "")
                    {
                        ...
                        if (SpecificRetryCnt >= 10)
                        {
                            ...
                            SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "We couldn't get a balance; please recheck you card/PIN numbers", ad.RsPathAndFileToWrite);
                            OK = "1";
                        }
                    }
                    else
