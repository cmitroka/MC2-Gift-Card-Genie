    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                //if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.button, HTMLEnumAttributes.OuterText, "Check Balance", "");
                if (OK != "-1") OK=DoGCGDelay(10,true);
            ...
            else
            {
                ...
                balanceResult = GetBalance("has a balance of ", "egift", test);
                OK = "1";
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
                    ...
                    OK = "-1";
                    if (test.Contains("We do not recognize the Gift Card"))
                    {
                        txtCardBalance.Text = "Not Recog";
                        SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "Victoria Secret does not recognize the Gift Card.", ad.RsPathAndFileToWrite);
                        OK = "1";
                    }
                    else if (test.Contains("To reveal your Secret Reward"))
                    {
                        txtCardBalance.Text = "Secret2";
                        SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "Sorry, Victoria Secret says: To reveal your Secret Reward value, you must present your Secret Reward card at checkout; 12/5-12/20.", ad.RsPathAndFileToWrite);
                        OK = "1";
                    }
                    else if (test.Contains("Your reward is so secret"))
                    {
                        txtCardBalance.Text = "Secret";
                        SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "There a balance, but Victoria's Secret isn't telling us.", ad.RsPathAndFileToWrite);
                        OK = "1";
                    }
