    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.src, "*%btn_checkbalance.gif", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("on this Gift Card is", "gift", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
