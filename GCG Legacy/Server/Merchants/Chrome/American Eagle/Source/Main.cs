    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                DoHandleValidateBytesSize2(0, 0, 80, 40, txtVBS1.Text);
                DoGCGDelay(3, true);
                DoUI.DoMouseClick(172, 735);
                DoGCGDelay(5, true);
            }
            else if (Instruction == 3)
            {
                DoHandleValidateBytesSize2(0, 0, 80, 40, txtVBS1.Text);
                DoUI.DoMouseClick(350, 409);
                DoHandleTyper(txtCardNumber.Text,0);
                DoGCGDelay(3, true);
                DoUI.DoMouseClick(504, 409);
                DoHandleTyper(txtCardPIN.Text);
                DoGCGDelay(3, true);
                DoUI.DoMouseClick(274, 525);
                DoGCGDelay(15, true);
                DoUI.DoMouseClick(406,626);
                HandleInstruction("1");
            }
            else
            {
                ...
                string temp= "/" + localDate.ToString("yy") + ":";

                //GCGMethods.WriteFile("C:\\test" + SpecificRetryCnt + ".txt", test, false);
                string balanceResult = GetBalance("gift card balance is:", "Your current balance", test);
                if (balanceResult == "")
                {
                    SpecificRetryCnt++;
                    ...
                    if (test.Contains("Select all "))
                    {
                        txtCardBalance.Text = "ReCAPTCHA";
                        SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "Lookup is being prevented by ReCAPTCHA.", ad.RsPathAndFileToWrite);
                        OK = "1";
