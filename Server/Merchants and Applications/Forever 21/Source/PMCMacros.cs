    ...
    public static class PMCMacros
    {
        ...
        public static void DoMacroSephora(Main m)
        {
            ...
            string FileToUse = GCGCommon.PMC.WriteMacro(m.txtRqRsPath.Text, "" +
                ...
                "SendText,{Delete}~!~" +
                "Pause,100~!~" +
                "TypeText,javascript:document.getElementById('email_returning').focus();,5~!~" +
                "SendText,{Enter}~!~" +
                "Pause,100~!~" +
                "SendText,^a~!~" +
                "Pause,100~!~" +
                "SendText," + m.txtLogin.Text + "{TAB}~!~" +
                "Pause,250~!~" +
                "SendText," + m.txtPassword.Text + "{TAB}{ENTER}~!~" +
                "Pause,5000~!~" +

                "Move,350,35~!~" +
                "LeftClick~!~" +
                "Pause,100~!~" +
                "TypeText,https://www.sephora.com/profile/MyAccount/PaymentMethods/paymentMethods.jsp,5~!~" +
                "SendText,{Enter}~!~" +
                "Pause,5000~!~" +
                ...
                "LeftClick~!~" +
                "Pause,100~!~" +
                "TypeText,javascript:document.getElementById('gc-number').focus();,5~!~" +
                "SendText,{Enter}~!~" +
                "Pause,300~!~" +
