...
namespace AppAdminSite
{
    public class GCGWebWSBL
    {
        ...
        public string DemoGCG(string pIP)
        {
            ...
            string[] temp1 = SupportMethods00.SplitByString(temp0, POSDEL);
            retVal = temp1[1];
            return retVal;
        }
        public string RegisterUserIns(string pGCGLogin, string pGCGPassword, string pUsersName, string pUsersEmail)
        {
            ...
            if (bDemo == true)
            {
                pGCGLogin = "GCGDemoUser" + SupportMethods00.CreateHexKey(20);
                System.Threading.Thread.Sleep(100);
                pGCGPassword = SupportMethods00.CreateHexKey(20);
            }
            else
            {
        ...
        public string ChangePassword(string pGCGKey, string pOldPassword, string pNewPassword)
        {
            ...
            if (SQLHelper.isDatasetBad(data))
            {
        ...
        public string GCGLogin(string pGCGLogin, string pGCGPassword)
        {
            ...
            if (SQLHelper.isDatasetBad(data)) return "1234567890";
            string GCGID = data[0][0];
            string UpdatedKey = SupportMethods00.CreateHexKey(15);
        ...
        public string CardBalSummarySel(string pGCGKey)
        {
            ...
            if (SQLHelper.isDatasetBad(data)) return null;
        ...
        public string MyCardsDataSel(string pGCGKey)
        {
            ...
            for (int i = 0; i < max; i++)
            {
                ...
                string CardTypeID = SupportMethods00.RemoveNonAlphaNumericChars(CardType);
        ...
        public string GetSupportedCards(string pGCGKey)
        {
            ...
            for (int i = 0; i < max; i++)
            {
                ...
                string IsLookupManual = data[i][6];
                string CardTypeID = SupportMethods00.RemoveNonAlphaNumericChars(CleanName);
        ...
        public string NewRequest(string pGCGKey, string pCardType, string pCardNumber, string pPIN)
        {
            ...
            if (SQLHelper.isDatasetBad(data) == false) CAPTCHAAdditionalInfo = data[0][0];
            ...
            rsType = WebserviceTypes.WSERR.ToString();
            string RqRsFileName = "";
            rsValue = "";
        ...
        public string NewManualRequest(string pGCGKey, string pCardType, string pCardNumber, string pPIN)
        {
            ...
            {
                String UniqueID = SupportMethods00.CreateHexKey(20);
                string[] LookupsCntData = GCGWebWSSM.GetLookupsCntData(GCGID);
                int AmntTest = Convert.ToInt16(LookupsCntData[3]);
                if (AmntTest <= 0)
                {
                ...
                GCGWebWSSM.InsertReponseUsingRetVal(GCGID, UniqueID, "MANUALLOOKUP" + LINEDEL + "0.00");
