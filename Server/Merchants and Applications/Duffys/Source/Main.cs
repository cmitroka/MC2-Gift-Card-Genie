    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.value, "Check Balance", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("Your Balance is", "card", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
