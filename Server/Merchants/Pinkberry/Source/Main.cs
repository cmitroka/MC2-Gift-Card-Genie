    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.OuterHtml, "<INPUT value=Submit type=submit>", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("Stored Value:", "PINKCARD", test);
                if (balanceResult == "")
                {
                    //Instruction--;
                    //SpecificRetryCnt++;
