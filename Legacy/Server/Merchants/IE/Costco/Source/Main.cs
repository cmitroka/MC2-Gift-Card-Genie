...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zinput, WebpageLib00.UsingIdentifier.Zname, WebpageLib00.ComparisonType.Zexact, "cash_account", txtCardNumber.Text, 1);
                //Typer t = new Typer();
                ...
                if (OK != "-1") OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zinput, WebpageLib00.UsingIdentifier.Zname, WebpageLib00.ComparisonType.Zexact, "cash_pin", txtCardPIN.Text, 1);
            ...
            else
            {
                ...
                balanceResult = GetBalance("Current Balance</p>", "</p>", testo);
                if (balanceResult == "")
                {
                    SpecificRetryCnt++;
