...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Zinput, WebpageLib00.UsingIdentifier.Zid, WebpageLib00.ComparisonType.Zexact, "gcnumber", txtCardNumber.Text, 1);
                ...
                if (OK != "-1") OK = WebpageLib00.ElemFindAndAct(IE, WebpageLib00.WhatIsIt.Za, WebpageLib00.UsingIdentifier.Zclass, WebpageLib00.ComparisonType.Zexact, "gcBalanceSubmit", "", 1);
                HandleInstruction(OK);
            }
            ...
            else
            {
                ...
                */
                balanceResult = GetBalance("Your Gift Card balance is:", "</span>", testi);
                if (balanceResult == "")
                {
                    SpecificRetryCnt++;
