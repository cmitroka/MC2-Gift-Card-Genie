...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.select, HTMLEnumAttributes.name, "country", "US");
            ...
            else if (Instruction == 3)
            {
                ...
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "biCardNumber", temp);
            ...
            else
            {
                ...
                balanceResult = GetBalance("card balance is:", "gift", test);
                if (balanceResult == "")
                {
                    //SpecificRetryCnt++;
