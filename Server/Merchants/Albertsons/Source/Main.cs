...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = SetFocus("password_ctl00$GiftCardContent$txtCardNumber", HTMLEnumTagNames.input); 
                HandleInstruction(OK);
            }
            else if (Instruction == 4)
            {
                OK = DoSendKeys(txtCardNumber.Text);
            }
            else if (Instruction == 5)
            {
                OK = "1"; //GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "password_ctl00$GiftCardContent$txtCardNumber", txtCardNumber.Text);
        ...
        private string SetFocus(string SearchForInOuterHtml, GCGCommon.HTMLEnumTagNames htmltype)
        {
            ...
            try
            {
                ...
                IHTMLDocument2 doc = null;
                doc1 = (HTMLDocument)webBrowser1.Document.DomDocument;
