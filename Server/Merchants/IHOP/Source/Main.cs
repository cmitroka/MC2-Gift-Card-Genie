...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "ctl00$ctl00$SiteMasterContent$Content$tbCardNumber", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "ctl00$ctl00$SiteMasterContent$Content$ucCaptcha$tbHipAlphaNumeric", txtCAPTCHAAnswer.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "ctl00$ctl00$SiteMasterContent$Content$btnSearch", "");
                HandleInstruction(OK);
            }
            else
            {
