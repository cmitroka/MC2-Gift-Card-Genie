    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            else if (Instruction == 2)
            {
                ...
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "gcPin", txtCardPIN.Text);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "cardBalanceFrmButton", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("Balance:", "Please", test);
                if (balanceResult == "")
                {
                    Instruction--;
                    SpecificRetryCnt++;
