...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        {
            /*
<input id="actnumber" type="text" name="ACCOUNT&lt;&gt;accountNumber" value="" size="30" tabindex="1">
<input id="actpin" type="password" name="ACCOUNT&lt;&gt;notificationEmail" value="" size="17" tabindex="2">
<img id="captchaImg" name="captchaImg" src="/captcha/captcha.cpa?rnd=0.9086859195958823">
<input id="captchaText" type="text" name="captchaText" size="30" tabindex="2">
<input type="image" name="CheckBalance" src="/media/images/egc/button_gray_checkbalance_v1_m56577569831477190.gif" width="111" height="20" border="0" alt="" tabindex="3" style="padding:0;border:none;">
             */
            ...
            */
            ...
            {
                OK = GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "actnumber", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "actpin", txtCardPIN.Text);
                if (OK == "1") OK = GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "captchaText", txtCAPTCHAAnswer.Text);
                if (OK == "1") OK = GCGMethods.SimInput(webBrowser1, HTMLEnumTagNames.input, HTMLEnumAttributes.name, "CheckBalance");
                HandleInstruction(OK);
            }
            else
            {
                ...
                string balanceResult = GetBalance("Gift Card Balance:", "form", test);
                if (balanceResult == "") 
                {
                    OK = "-1";
                    HandleInstruction(OK);
