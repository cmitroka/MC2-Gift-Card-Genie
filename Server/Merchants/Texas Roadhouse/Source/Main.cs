            ...
            try
            {
                ...
                else
                {
                    ...
                    if (balanceResult == "")
                    {
                        ...
                        else if (testi.Contains("The Security Code you have entered did not match the code in the image."))
                        {
                            txtCardBalance.Text = "Security";
                            SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "Try again, you entered the wrong letters/numbers from the image.", ad.RsPathAndFileToWrite);
                            OK = "1";
                        }
                        else if (testi.Contains("The Card Number and/or PIN # you have entered are incorrect."))
                        {
                            txtCardBalance.Text = "Inv";
                            SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "The Card Number and/or PIN # you have entered are incorrect.", ad.RsPathAndFileToWrite);
                            OK = "1";
                        }
                        else if (testi.Contains("To inquire about your card's balance or transaction history, please call the number"))
                        {
                            txtCardBalance.Text = "Unk";
                            SupportMethods.WriteResponseFile(GCGCommon.GCTypes.GCCUSTOM.ToString(), "Sorry, couldn't get the balance - but your card is probably valid.  You can try again, will hopefully work.", ad.RsPathAndFileToWrite);
                            OK = "1";
                        }
                        //
                    }
