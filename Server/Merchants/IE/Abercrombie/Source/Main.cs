        ...
        private void ProcessInstructions()
        {
            try
            {
                ...
                else if (Instruction == 2)
                {
                    ...
                    if (OK == "1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zselect, GCGMethods.HTMLAttributes.Zname, "country", "US");
                ...
                else if (Instruction == 3)
                {
                    ...
                    SetForegroundWindowByHWND(IE.HWND);
                    IHTMLDocument2 x = GCGMethods.ConvertIEToIHTMLDocument2(IE, -1);
                    string temp = txtCardNumber.Text + txtCardPIN.Text;


                    OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Zinput, GCGMethods.HTMLAttributes.Zname, "biCardNumber", temp);
                    if (OK == "1") OK = GCGMethods.SimInput(x, GCGMethods.HTMLTagNames.Za, GCGMethods.HTMLAttributes.ZInnerText, "Check Balance", "");
                    HandleInstruction(OK);
                }
                else
                {
                    ...
                    balanceResult = GetBalance("amount\">", "</li>", test);
                    if (balanceResult == "")
                    {
                        SpecificRetryCnt++;
