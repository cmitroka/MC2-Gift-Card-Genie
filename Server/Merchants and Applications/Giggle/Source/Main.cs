...
namespace DVB
{
    ...
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "dwfrm_giftcert_balance_giftCertificateID", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "dwfrm_giftcert_balance_giftCertificatePin", txtCardPIN.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.button, HTMLEnumAttributes.id, "CheckBalanceButton", "");
            ...
            else
            {
                ...
                balanceResult = GetBalance("PIN:", "oh", test);
                if (balanceResult == "")
                {
                    Instruction--;
                    //SpecificRetryCnt++;
