...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                //OK = GCGMethods.ElementExists(FrameDoc, HTMLEnumTagNames.img, HTMLEnumAttributes.src, "*%giftcard-landing");
                //if (OK == "1") PMCMacros.DoMacro1(this);
            ...
            else
            {
                ...
                test = GCGMethods.GetHTML(FrameDoc);
                //GCGMethods.WriteFile("C:\\GetBalance.txt", test, true);
                string RoughBalance = GCGMethods.RoughExtract(txtCardNumber.Text, "cadBal_", test);
                //GCGMethods.WriteFile("C:\\GetBalance.txt", RoughBalance, true);
                string balanceResult = GetBalance("$", "USD", RoughBalance);
                if (balanceResult == "")
                {
                    OK = "-1";
