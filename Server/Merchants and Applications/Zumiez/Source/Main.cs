...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "gift-card-number", txtCardNumber.Text);
                if (OK == "1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "gift-card-pin", txtCardPIN.Text);
                if (OK == "1")
                {
                    OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.button, HTMLEnumAttributes.InnerText, "CHECK BALANCE", "");
                }
            ...
            else
            {
                ...
                balanceResult = GetBalance("Balance is:", "jQuery", test);
                if (balanceResult == "")
                {
                    OK = "-1";
