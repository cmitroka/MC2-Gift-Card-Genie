...
namespace DVB
{
    public partial class Main : Form
    {
        ...
        private void ProcessInstructions()
        {
            ...
            {
                OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_ContentPlaceHolder1_Balance1_txtCardNum", txtCardNumber.Text);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_ContentPlaceHolder1_Balance1_txtCardPin", txtCardPIN.Text);
                if (OK != "-1") OK = GCGMethods.SimInput2(FrameDoc, HTMLEnumTagNames.input, HTMLEnumAttributes.id, "ctl00_ContentPlaceHolder1_Balance1_btnInquire", "");
            ...
            else
            {
                ...
                if (balanceResult == "") balanceResult = GetBalance("Available Balance:", "Date", test);
                if (balanceResult == "")
                {
                    OK = "-1";
                    string VendErr1 = "Invalid Gift Card number or Pin, please try again.";
